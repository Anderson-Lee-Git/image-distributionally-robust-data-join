#!/bin/bash
#
#SBATCH --job-name=baseline-celebA
...
#SBATCH --output=/gscratch/jamiemmt/andersonlee/image-distributionally-robust-data-join/logs/resnet50_baseline_celebA/out.log
#SBATCH --error=/gscratch/jamiemmt/andersonlee/image-distributionally-robust-data-join/logs/resnet50_baseline_celebA/out.err
...
PROJECT_NAME='resnet50_baseline_celebA'
